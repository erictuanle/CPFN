...
// output: out(b, c, n)
__global__ void three_weighted_sum_kernel(int b, int c, int m, int n,
...
void three_weighted_sum_kernel_wrapper(int b, int c, int m, int n,
                                      const float *points, const int *idx,
                                      const float *weight, float *out) {
  cudaStream_t stream = at::cuda::getCurrentCUDAStream();
  three_weighted_sum_kernel<<<b, opt_block_config(n, c), 0, stream>>>(
...
__global__ void three_weighted_sum_grad_kernel(
...
void three_weighted_sum_grad_kernel_wrapper(int b, int c, int n, int m,
                                           const float *grad_out,
                                           const int *idx, const float *weight,
                                           float *grad_points) {
  cudaStream_t stream = at::cuda::getCurrentCUDAStream();
  three_weighted_sum_grad_kernel<<<b, opt_block_config(n, c), 0, stream>>>(
